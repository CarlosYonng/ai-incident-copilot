...
CREATE TABLE IF NOT EXISTS tool_call_log (
  ...
  node_name VARCHAR(128) NOT NULL COMMENT '调用工具的 Workflow 节点名称。',
  ...
  error_message TEXT NULL COMMENT 'success 为 false 时的错误详情。',
...
CREATE TABLE IF NOT EXISTS action_proposal (
  ...
  action_type VARCHAR(64) NOT NULL COMMENT 'UI 和审计使用的稳定操作编码。',
